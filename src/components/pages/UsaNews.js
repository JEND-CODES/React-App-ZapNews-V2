...
class UsaNews extends Component {
    constructor() {
        super()
        this.state = {
          data: null,
    ...
    getData() {
        ...
        let data = fetch('https://newsapi.org/v2/top-headlines?country=us&category=technology&apiKey=09554bc11b0b4e4cb4d22c519e42604b')
    ...
    getData2() {
        ...
        let data = fetch('https://newsapi.org/v2/top-headlines?country=us&category=sports&apiKey=09554bc11b0b4e4cb4d22c519e42604b')
    ...
    getData3() {
        ...
        let data = fetch('http://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=09554bc11b0b4e4cb4d22c519e42604b')
    ...
    getData4() {
        ...
        let data = fetch('https://newsapi.org/v2/top-headlines?country=us&category=health&apiKey=09554bc11b0b4e4cb4d22c519e42604b')
    ...
    getData5() {
        ...
        let data = fetch('https://newsapi.org/v2/top-headlines?country=us&category=science&apiKey=09554bc11b0b4e4cb4d22c519e42604b')
    ...
    getData6() {
        ...
        let data = fetch('http://newsapi.org/v2/top-headlines?country=us&category=entertainment&apiKey=09554bc11b0b4e4cb4d22c519e42604b')
    ...
    getData7() {
        ...
        let data_first = fetch('http://newsapi.org/v2/top-headlines?country=us&apiKey=09554bc11b0b4e4cb4d22c519e42604b')
...
window.scrollTo(0, 0);
        ...
        return (
            ...
            <SubTitleLogo>
              <p className="subtitle-position">USA</p>
            </SubTitleLogo>
